            ...
            <form onSubmit={handleSearch} className="flex-1 max-w-2xl">
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 pr-4 py-3 text-base rounded-full border-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-400 focus:ring-blue-500 dark:focus:ring-blue-400"
                />
              </div>
            </form>
          </div>
              ...
              <div>
                ...
                >
                  {filteredResults.users.map((user, index) => (
                    ...
                    >
                      <Card className="hover:shadow-lg dark:hover:shadow-2xl transition-all duration-300 border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600">
                          ...
                          <Link href={`/profile/${user.firebaseUid}`}>
                            <div className="flex items-center gap-4 group cursor-pointer">
                              {user.profilePicture ? (
                                ...
                                <div className="w-16 h-16 bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-500 dark:to-purple-500 rounded-full flex items-center justify-center text-white font-semibold ring-2 ring-gray-200 dark:ring-gray-700 group-hover:ring-blue-300 dark:group-hover:ring-blue-500 transition-all duration-200">
                                  {getInitials(user.name)}
                                </div>
                              )}
                              <div className="flex-1 min-w-0">
                                <h3 className="font-semibold text-gray-900 dark:text-white truncate group-hover:text-blue-700 dark:group-hover:text-blue-400 transition-colors duration-200">
                                  {user.name}
                                </h3>
                              ...
                              <div className="flex items-start gap-4 mb-4">
                                {post.authorProfilePicture ? (
                                  <img
                                    ...
                                    alt={post.authorName}
                                    className="w-12 h-12 rounded-full object-cover ring-2 ring-gray-200 dark:ring-gray-700 group-hover:ring-green-300 dark:group-hover:ring-green-500 transition-all duration-200"
                                  />
                                ) : (
                                  <div className="w-12 h-12 bg-gradient-to-r from-green-600 to-teal-600 dark:from-green-500 dark:to-teal-500 rounded-full flex items-center justify-center text-white font-semibold ring-2 ring-gray-200 dark:ring-gray-700 group-hover:ring-green-300 dark:group-hover:ring-green-500 transition-all duration-200">
                                    {getInitials(post.authorName)}
                                  </div>
                                )}
                                <div className="flex-1">
                                  <div className="flex items-center gap-2 mb-2">
                                    <h3 className="font-semibold text-gray-900 dark:text-white group-hover:text-green-700 dark:group-hover:text-green-400 transition-colors duration-200">
                                      {post.authorName}
                                    </h3>
